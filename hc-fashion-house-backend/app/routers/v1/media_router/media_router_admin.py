"""
Media Router Admin - Admin media upload and management endpoints
All uploads and state-changing operations for media assets
"""
...
router = APIRouter(prefix="/media", tags=["Media Admin"])
...
@router.patch(
    ...
    response_model=MediaUploadResponse,
    summary="Set Primary Media for Variant",
